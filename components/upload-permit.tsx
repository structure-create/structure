...
//           {
//             category: "Violations",
//             items: data.violations.map((v: any, idx: number) => (
        ...
        issues: [
          {
            category: "Violations",
            items: data.violations.map((v: any, idx: number) => (
              <div key={`${v.page}-${idx}`} className="mb-6">
                <p className="font-bold underline">{v.violation.citation}</p>
                <p className="mt-1 italic">&ldquo;{v.violation.quote}&rdquo;</p>
                <p className="mt-1 text-gray-700">{v.violation.reason}</p>
              </div>
            )),
          },
        ],
