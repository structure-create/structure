...
export function Intro() {
  return (
    ...
    <section className="max-w-7xl mx-auto px-1 py-12 overflow-visible relative">
      {/* grid is top-aligned */}
      <div className="h-full grid grid-cols-1 md:grid-cols-2 gap-12">
        ...
        <div className = "gap-12">
          <p className="text-4xl md:text-8xl font-bold leading-tight pt-[40px]">
          ...
          <div className="mt-6 flex flex-wrap gap-4">
            ...
            <Link href="/signup">
              <p className="px-6 py-3 bg-[#F5E1D1] hover:bg-[#EAD3C0] text-[#B35A2D] rounded-md">
                Create an account
              </p>
            </Link>
          </div>
